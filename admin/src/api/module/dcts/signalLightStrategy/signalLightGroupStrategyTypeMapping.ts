...
export const signalLightGroupStrategyTypeMappingApi: ApiConfig<SignalLightGroupStrategyTypeMappingDto, SignalLightGroupStrategyTypeMappingUpdDto> = {
  ...
  selectAll: (params) => request({
    url: '/dcts/signal-light-strategy/signal-light-group-strategy-type-mapping/all',
    method: 'GET',
    params: params
  }),
  /**
  ...
  selectById: (id) => request({
    url: `/dcts/signal-light-strategy/signal-light-group-strategy-type-mapping/${id}`,
    method: 'GET'
  }),
  /**
   * 查询多个
  ...
  selectByIds: (ids) => request({
    url: `/dcts/signal-light-strategy/signal-light-group-strategy-type-mapping/ids`,
    method: 'GET',
    params: ids
  }),
  /**
  ...
  insertMore: (objs) => request({
    url: '/dcts/signal-light-strategy/signal-light-group-strategy-type-mapping/s',
    method: 'POST',
    data: {
      items: objs,
    }
