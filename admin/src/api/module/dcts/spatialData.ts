 ...
 * @param data
 */
export function getAircraftsInPolygonApi(data: GetAircraftsInPolygonDto) {
  return request<GetAircraftsInPolygonVo>({
    url: '/dcts/spatial-data/get-aircrafts-in-polygon',
    method: 'POST',
    data: data,
  })
}
