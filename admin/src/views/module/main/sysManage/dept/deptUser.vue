...
const getInfo = () => {
  ...
  userDeptApi.selectAll({
    ...
    userApi.selectList({
      ...
      userDeptsOfThisDept.value = res0.filter(item => ids.includes(item.userId))
      usersOfThisDept.value = res.list
