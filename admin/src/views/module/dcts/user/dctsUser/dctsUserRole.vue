...
import { DctsUserDto2 } from "@/type/module/dcts/user/dctsUser.ts";
import { inject, nextTick, reactive, Ref, toRaw, useTemplateRef, watch } from "vue";
...
<template>
  ...
  <el-form>
    <el-row>
      <el-col :span="8">
        <el-form-item :label="dctsUserDict.id">
          {{ props.user.id }}
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item :label="dctsUserDict.username">
          {{ props.user.username }}
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item :label="dctsUserDict.nickname">
          {{ props.user.nickname }}
        </el-form-item>
      </el-col>
    </el-row>
