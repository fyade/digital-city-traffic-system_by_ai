    ...
    <template v-if="activeTabName===final.more">
      ...
      >
        ...
        >
          ...
          <el-table-column prop="scheduleType" :label="signalLightStrategyScheduleDict.scheduleType" width="300">
            <template #header>
              <span :class="ifRequired('scheduleType')?'tp-table-header-required':''">{{ signalLightStrategyScheduleDict.scheduleType }}</span>
            </template>
            <template #default="{$index}">
              <div :class="state.dialogForms_error?.[`${$index}-scheduleType`] ? 'tp-table-cell-bg-red' : 'tp-table-cell'">
                <el-input v-model="state.dialogForms[$index].scheduleType" :placeholder="signalLightStrategyScheduleDict.scheduleType"/>
              </div>
            </template>
          </el-table-column>
          <el-table-column prop="startTime" :label="signalLightStrategyScheduleDict.startTime" width="300">
            <template #header>
              <span :class="ifRequired('startTime')?'tp-table-header-required':''">{{ signalLightStrategyScheduleDict.startTime }}</span>
            </template>
            <template #default="{$index}">
          ...
          <el-table-column prop="endTime" :label="signalLightStrategyScheduleDict.endTime" width="300">
            <template #header>
              <span :class="ifRequired('endTime')?'tp-table-header-required':''">{{ signalLightStrategyScheduleDict.endTime }}</span>
            </template>
            <template #default="{$index}">
          ...
          <el-table-column prop="cronExpression" :label="signalLightStrategyScheduleDict.cronExpression" width="300">
            <template #header>
              <span :class="ifRequired('cronExpression')?'tp-table-header-required':''">{{ signalLightStrategyScheduleDict.cronExpression }}</span>
            </template>
            <template #default="{$index}">
              <div :class="state.dialogForms_error?.[`${$index}-cronExpression`] ? 'tp-table-cell-bg-red' : 'tp-table-cell'">
                <el-input v-model="state.dialogForms[$index].cronExpression" :placeholder="signalLightStrategyScheduleDict.cronExpression"/>
              </div>
            </template>
          </el-table-column>
