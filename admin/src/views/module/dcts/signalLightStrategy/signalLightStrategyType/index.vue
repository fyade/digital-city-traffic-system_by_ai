...
<template>
  ...
  <div class="zs-table-data">
    ...
    >
      ...
      <!--上面id列的宽度改一下-->
      <!--在此下方添加表格列-->
      <el-table-column prop="name" :label="signalLightStrategyTypeDict.name" width="240"/>
      <el-table-column prop="description" :label="signalLightStrategyTypeDict.description" width="360"/>
      <!--在此上方添加表格列-->
