<script lang="ts">
export default {
  name: 'dcts:airspace:userFlightRouteUserApply'
}
</script>
...
import { UserFlightRouteUserApplyDto, UserFlightRouteUserApplyUpdDto } from "@/type/module/dcts/airspace/userFlightRouteUserApply.ts";
...
const {
  ...
  dfDel,
  ifRequired,
} = funcTablePage<UserFlightRouteUserApplyDto, UserFlightRouteUserApplyUpdDto>({
  state,
  dFormRules,
  config,
  api: userFlightRouteUserApplyApi,
  dict: userFlightRouteUserApplyDict,
})
...
<template>
  ...
  >
    ...
    <template v-if="activeTabName===final.one">
      ...
      >
        ...
        <!--  <el-col :span="12"></el-col>-->
        <!--</el-row>-->
        <el-form-item v-if="dialogType.value!==final.ins" :label="userFlightRouteUserApplyDict.id" prop="id">
          <span>{{ state.dialogForm.id }}</span>
        </el-form-item>
        <!--在此下方添加表单项-->
        <el-row>
          <el-col :span="24">
            <el-form-item :label="userFlightRouteUserApplyDict.aircraftId" prop="aircraftId">
              <!--<el-input v-model="state.dialogForm.aircraftId" :placeholder="userFlightRouteUserApplyDict.aircraftId"/>-->
              <el-select
                  v-model="selectValue"
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item :label="userFlightRouteUserApplyDict.taskName" prop="taskName">
              <el-input v-model="state.dialogForm.taskName" :placeholder="userFlightRouteUserApplyDict.taskName"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item :label="userFlightRouteUserApplyDict.path" prop="path">
              <el-input v-model="state.dialogForm.path" :placeholder="userFlightRouteUserApplyDict.path"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item :label="userFlightRouteUserApplyDict.startTime" prop="startTime">
              <el-date-picker type="datetime" v-model="state.dialogForm.startTime" :placeholder="userFlightRouteUserApplyDict.startTime"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <!--在此上方添加表单项-->
        <!--<el-form-item :label="userFlightRouteUserApplyDict.orderNum" prop='orderNum'>-->
        <!--  <el-input-number v-model="state.dialogForm.orderNum" controls-position="right"/>-->
        <!--</el-form-item>-->
        <!--<el-form-item :label="userFlightRouteUserApplyDict.ifDefault" prop='ifDefault'>-->
        <!--  <el-switch v-model="state.dialogForm.ifDefault" :active-value='final.Y' :inactive-value='final.N'/>-->
        <!--</el-form-item>-->
        <!--<el-form-item :label="userFlightRouteUserApplyDict.ifDisabled" prop='ifDisabled'>-->
  ...
  <div class="zs-filter-form" v-show="filterFormVisible1 && filterFormVisible">
    ...
    >
      ...
      <el-form-item :label="userFlightRouteUserApplyDict.taskName" prop="taskName">
        <el-input v-model="state.filterForm.taskName" :placeholder="userFlightRouteUserApplyDict.taskName"/>
      </el-form-item>
      <el-form-item :label="userFlightRouteUserApplyDict.startTime" prop="startTime">
        <el-date-picker
  ...
  <div class="zs-table-data">
    ...
    >
      ...
      <!--<el-table-column fixed prop="id" :label="userFlightRouteUserApplyDict.id" width="180"/>-->
      <!--上面id列的宽度改一下-->
      <!--在此下方添加表格列-->
      <el-table-column prop="aircraftId" :label="userFlightRouteUserApplyDict.aircraftId" width="240">
      ...
      <el-table-column prop="taskName" :label="userFlightRouteUserApplyDict.taskName" width="240"/>
      <el-table-column prop="path" :label="userFlightRouteUserApplyDict.path" width="360">
        <template #default="{row}">
          <div style="max-height: 100px;overflow: auto;">{{ row.path }}</div>
        </template>
      </el-table-column>
      <el-table-column prop="startTime" :label="userFlightRouteUserApplyDict.startTime" width="180">
        <template #default="{row}">
          {{ timeUtils.formatDate(new Date(row.startTime)) }}
        </template>
      </el-table-column>
      <el-table-column prop="endTime" :label="userFlightRouteUserApplyDict.endTime" width="180">
        <template #default="{row}">
      ...
      <!--<el-table-column prop="createBy" :label="userFlightRouteUserApplyDict.createBy" width="120"/>-->
      <!--<el-table-column prop="updateBy" :label="userFlightRouteUserApplyDict.updateBy" width="120"/>-->
      <!--<el-table-column prop="createTime" :label="userFlightRouteUserApplyDict.createTime" width="220"/>-->
      <!--<el-table-column prop="updateTime" :label="userFlightRouteUserApplyDict.updateTime" width="220"/>-->
      <!--<el-table-column prop="deleted" :label="userFlightRouteUserApplyDict.deleted" width="60"/>-->
      <!--上方几个酌情使用-->
