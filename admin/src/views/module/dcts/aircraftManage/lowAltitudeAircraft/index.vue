<script lang="ts">
export default {
  name: 'dcts:aircraftManage:lowAltitudeAircraft'
}
</script>
...
const {
  ...
  dfDel,
  ifRequired,
} = funcTablePage<LowAltitudeAircraftDto, LowAltitudeAircraftUpdDto>({
  state,
  dFormRules,
  config,
...
<template>
  ...
  >
    ...
    <template v-if="activeTabName===final.one">
      ...
      >
        ...
        <!--  <el-col :span="12"></el-col>-->
        <!--</el-row>-->
        <el-form-item v-if="dialogType.value!==final.ins" :label="lowAltitudeAircraftDict.id" prop="id">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item :label="lowAltitudeAircraftDict.aircraftName" prop="aircraftName">
              <el-input v-model="state.dialogForm.aircraftName" :placeholder="lowAltitudeAircraftDict.aircraftName"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item :label="lowAltitudeAircraftDict.serialNumber" prop="serialNumber">
              <el-input v-model="state.dialogForm.serialNumber" :placeholder="lowAltitudeAircraftDict.serialNumber"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <!--在此上方添加表单项-->
        <!--<el-form-item :label="lowAltitudeAircraftDict.orderNum" prop='orderNum'>-->
        <!--  <el-input-number v-model="state.dialogForm.orderNum" controls-position="right"/>-->
        <!--</el-form-item>-->
        <!--<el-form-item :label="lowAltitudeAircraftDict.ifDefault" prop='ifDefault'>-->
        <!--  <el-switch v-model="state.dialogForm.ifDefault" :active-value='final.Y' :inactive-value='final.N'/>-->
        <!--</el-form-item>-->
        <!--<el-form-item :label="lowAltitudeAircraftDict.ifDisabled" prop='ifDisabled'>-->
    ...
    <template v-if="activeTabName===final.more">
      ...
      >
        ...
        >
          ...
          <!--在此下方添加表格列-->
          <el-table-column prop="aircraftName" :label="lowAltitudeAircraftDict.aircraftName" width="300">
            <template #header>
              <span :class="ifRequired('aircraftName')?'tp-table-header-required':''">{{ lowAltitudeAircraftDict.aircraftName }}</span>
            </template>
            <template #default="{$index}">
              <el-form-item :prop="`${$index}.aircraftName`" :rules="dFormRules.aircraftName">
                <el-input v-model="state.dialogForms[$index].aircraftName" :placeholder="lowAltitudeAircraftDict.aircraftName"/>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column prop="serialNumber" :label="lowAltitudeAircraftDict.serialNumber" width="300">
            <template #header>
              <span :class="ifRequired('serialNumber')?'tp-table-header-required':''">{{ lowAltitudeAircraftDict.serialNumber }}</span>
            </template>
            <template #default="{$index}">
              <el-form-item :prop="`${$index}.serialNumber`" :rules="dFormRules.serialNumber">
                <el-input v-model="state.dialogForms[$index].serialNumber" :placeholder="lowAltitudeAircraftDict.serialNumber"/>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column prop="registrationNumber" :label="lowAltitudeAircraftDict.registrationNumber" width="300">
            <template #header>
              <span :class="ifRequired('registrationNumber')?'tp-table-header-required':''">{{ lowAltitudeAircraftDict.registrationNumber }}</span>
            </template>
            <template #default="{$index}">
              <el-form-item :prop="`${$index}.registrationNumber`" :rules="dFormRules.registrationNumber">
                <el-input v-model="state.dialogForms[$index].registrationNumber" :placeholder="lowAltitudeAircraftDict.registrationNumber"/>
              </el-form-item>
            </template>
          </el-table-column>
  ...
  <div class="zs-table-data">
    ...
    >
      ...
      <!--<el-table-column fixed prop="id" :label="lowAltitudeAircraftDict.id" width="180"/>-->
      <!--上面id列的宽度改一下-->
      <!--在此下方添加表格列-->
      ...
      <!--<el-table-column prop="createBy" :label="lowAltitudeAircraftDict.createBy" width="120"/>-->
      <!--<el-table-column prop="updateBy" :label="lowAltitudeAircraftDict.updateBy" width="120"/>-->
      <!--<el-table-column prop="createTime" :label="lowAltitudeAircraftDict.createTime" width="220"/>-->
      <!--<el-table-column prop="updateTime" :label="lowAltitudeAircraftDict.updateTime" width="220"/>-->
      <!--<el-table-column prop="deleted" :label="lowAltitudeAircraftDict.deleted" width="60"/>-->
      <!--上方几个酌情使用-->
