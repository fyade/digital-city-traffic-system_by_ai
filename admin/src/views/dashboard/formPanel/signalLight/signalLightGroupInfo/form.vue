...
const init = () => {
  if (ifIns) {
    const cacheData = dashboardStore.getCurrentCacheData<SignalLightGroupInfoDto>(0)
    if (cacheData) {
...
watch(form.value, () => {
  dashboardStore.setCurrentCacheData<SignalLightGroupInfoDto>(0, form.value)
});
const dCon = () => {
    ...
    <template v-if="ifIns || ifUpd">
      <n-spin :show="formLoading">
        ...
        >
          ...
          <n-form-item class="no-padding-right" path="location" :label="signalLightGroupInfoDict.location">
