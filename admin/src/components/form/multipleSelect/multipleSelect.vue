...
<template>
  <el-select v-model="linshiParam" :placeholder="props.placeholder" multiple clearable filterable @change="linshiParamChange">
    <el-option v-for="key in Object.keys(props.kvs)" :key="key" :label="kvs[key]" :value="key"/>
  </el-select>
</template>
