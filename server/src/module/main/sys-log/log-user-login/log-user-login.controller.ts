...
import { LogUserLoginSelListDto, LogUserLoginSelAllDto, LogUserLoginInsOneDto, LogUserLoginUpdOneDto, LogUserLoginInsMoreDto, LogUserLoginUpdMoreDto } from './dto';
...
export class LogUserLoginController {
  ...
  async insLogUserLogins(@Body() dto: LogUserLoginInsMoreDto): Promise<R> {
    return this.logUserLoginService.insLogUserLogins(dto.items);
  }
  ...
  async updLogUserLogins(@Body() dto: LogUserLoginUpdMoreDto): Promise<R> {
    return this.logUserLoginService.updLogUserLogins(dto.items);
  }
