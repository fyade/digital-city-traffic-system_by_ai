...
export class UserFlightRouteUserApplyDto extends BaseDto {
  id: number;
...
export class UserFlightRouteUserApplySelListDto extends PageDto {
...
export class UserFlightRouteUserApplyInsOneDto {
...
export class UserFlightRouteUserApplyUpdOneDto extends UserFlightRouteUserApplyInsOneDto {
  @ApiProperty({ description: '主键id', required: true })
  @IsNotEmpty({ message: '主键id不能为空' })
  id: number;
}

export class UserFlightRouteUserApplyInsMoreDto {
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => UserFlightRouteUserApplyInsOneDto)
  items: UserFlightRouteUserApplyInsOneDto[];
}

export class UserFlightRouteUserApplyUpdMoreDto {
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => UserFlightRouteUserApplyUpdOneDto)
  items: UserFlightRouteUserApplyUpdOneDto[];
}
