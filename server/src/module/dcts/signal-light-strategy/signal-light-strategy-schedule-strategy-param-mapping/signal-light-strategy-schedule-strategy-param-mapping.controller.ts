...
export class SignalLightStrategyScheduleStrategyParamMappingController {
  ...
  async selOnesSignalLightStrategyScheduleStrategyParamMapping(@Query() ids: Record<string, string>): Promise<R> {
    return this.signalLightStrategyScheduleStrategyParamMappingService.selOnesSignalLightStrategyScheduleStrategyParamMapping(Object.values(ids).map(Number));
  }
  ...
  async selOneSignalLightStrategyScheduleStrategyParamMapping(@Param('id') id: string): Promise<R> {
    return this.signalLightStrategyScheduleStrategyParamMappingService.selOneSignalLightStrategyScheduleStrategyParamMapping(Number(id));
  }
