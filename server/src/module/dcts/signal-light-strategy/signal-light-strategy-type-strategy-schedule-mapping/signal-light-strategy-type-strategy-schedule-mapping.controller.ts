...
export class SignalLightStrategyTypeStrategyScheduleMappingController {
  ...
  async selOnesSignalLightStrategyTypeStrategyScheduleMapping(@Query() ids: Record<string, string>): Promise<R> {
    return this.signalLightStrategyTypeStrategyScheduleMappingService.selOnesSignalLightStrategyTypeStrategyScheduleMapping(Object.values(ids).map(Number));
  }
  ...
  async selOneSignalLightStrategyTypeStrategyScheduleMapping(@Param('id') id: string): Promise<R> {
    return this.signalLightStrategyTypeStrategyScheduleMappingService.selOneSignalLightStrategyTypeStrategyScheduleMapping(Number(id));
  }
