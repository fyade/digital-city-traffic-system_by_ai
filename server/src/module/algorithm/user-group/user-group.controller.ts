...
export class UserGroupController {
  ...
  async selOnesUserGroup(@Query() ids: Record<string, string>): Promise<R> {
    return this.userGroupService.selOnesUserGroup(Object.values(ids).map(Number));
  }
  ...
  async selOneUserGroup(@Param('id') id: string): Promise<R> {
    return this.userGroupService.selOneUserGroup(Number(id));
  }
